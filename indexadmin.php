...
<head>
  ...
  <title>HealthDesk - Admin Panel</title>
...
<body>
  <div class="navbar">
    ...
    <div class="title">HealthDesk - Admin Panel</div>
  ...
  <div class="container">
    <nav class="sidebar" id="sidebar">
      <ul>
        ...
        <li onclick="mostrarAñadir()"><i class="fas fa-user-plus"></i>Añadir Enfermera/Usuario</li>
        <li onclick="mostrarUsuarios()"><i class="fas fa-user"></i>Gestionar Usuarios</li>
